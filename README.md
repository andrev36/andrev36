...
<p align="left">
                I'm learning web development for more than one year. During my journey
                I've worked with technologies like HTML5, CSS3, Javascript
                (ES5+), Git, React.js, Redux, Typescript, Node.js (Express
                Framework), npm, Bootstrap 4, Material UI, REST/GraphQL APIs,
                ...
                register a domain name and deploy websites safely. In my
